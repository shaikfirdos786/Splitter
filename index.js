...
function handleInput() {
  ...
  if (!isNaN(billAmount) && !isNaN(totalPeople) && selectedTipPercentage !== null && totalPeople > 0) {
    ...
    calculateTip(billAmount, totalPeople);
...
function calculateTip(billAmount, totalPeople) {
  if (!isNaN(billAmount) && !isNaN(totalPeople) && totalPeople > 0 && selectedTipPercentage !== null) {
    let tip;
